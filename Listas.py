...
x = [0,1,2,3,1,4,0]
x.insert(0,True)#Siempre que se agregue un numero negativo lo interpretara como regresivo
print(x)#Si se quiere imprimir una parte de la lista solo hay que cuidar que no salga del rango